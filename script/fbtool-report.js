...
module.exports.config = {
  name: "fbreport",
  aliases: ["spamreport", "spam-report", "report", "reportv1", "reportv2", "sunog", "fb-report", "mass-report", "massreport"],
  version: "1.0",
  role: 3,
  credits: "Kenneth Panio",
  info: "Report a Facebook account",
  type: "tools",
  usage: "[token] [user_id] [amount]",
  cd: 6
};
